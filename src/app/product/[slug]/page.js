  ...
  return (
    <div className={styles.page}>
      <div className={styles.breadcrumb}>
        <Link href="/">Home</Link> / <Link href="/shop">Products</Link> / {product.name}
      </div>
      ...
      <div className={styles.layout}>
        ...
        <div>
          ...
          <Link href="/locations" className={styles.storeButton}>Find a Store</Link>
        </div>
      </div>

      {relatedProducts.length > 0 && (
        <div className={styles.relatedSection}>
          <h2 className={styles.relatedTitle}>More In Store</h2>
