    ...
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeading}>
          ...
          <p className={styles.sectionSubtitle}>Explore the essentials stocked at bokku! stores</p>
        </div>
      ...
      <section className={styles.section}>
        <div className={styles.productHeader}>
          <div>
            <h2 className={styles.sectionTitle}>Popular In Store</h2>
            <p className={styles.sectionSubtitle}>Top selections available inside your community stores</p>
          </div>
          <Link href="/locations" className={styles.pillActive}>Find a Store</Link>
        </div>
